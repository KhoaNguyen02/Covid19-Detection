...
from model.initializer.Parameters import Initialize
from model.optimizer.Optimization import *
from model.activation_functions.ActivationFunctions import *
...
class MLP:
    ...
    def fit(self, X, y):
        ...
        for i in range(self.n_iterations):
            ...
            print("Epoch {}/{}: - loss: {:.8f}. - training accuracy: {:.8f} - time passed: {:.3f}". \
                format(i + 1, self.n_iterations, cost, accuracy, time.time() - self.start_time))
    ...
    def plot(self):
        ...
        if self.n_iterations <= 100:
            print("This feature only works if number of iterations is larger than 100")
        else:
